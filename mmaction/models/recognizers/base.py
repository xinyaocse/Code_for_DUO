...
class BaseRecognizer(nn.Module, metaclass=ABCMeta):
    ...
    def forward(self, imgs, label=None, return_loss=False, return_label=True, return_logit=False, **kwargs):
        #print(imgs.size())
        # exit()
        """Define the computation performed at every call."""
        # print(label, return_loss, return_logit)
        ...
        if return_logit:
            return self.forward_train(imgs, label, return_logit=True, **kwargs)
        if return_label:
