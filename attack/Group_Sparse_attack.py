...
Group_Sparse_attack is the code of the new attack method proposed by our current work to improve the query efficiency
"""
...
class Group_Sparse_attack(TrainBase):
    def __init__(self, s_net, t_net, query_iter, target_iter, s_db, s_dl, t_db, t_dl, parser, device, classes):
        super(Group_Sparse_attack, self).__init__(s_net, t_net, query_iter, target_iter, s_db, s_dl, t_db, t_dl, parser, device,
                                          classes)
        pass
