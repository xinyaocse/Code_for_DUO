...
data_root = '/root/public/dev8T/Dataset/JESTER'  # changed
data_root_val = '/root/public/dev8T/Dataset/JESTER'  # changed
...
ann_file_test = f'tools/data/jester/jester_val_list_rawframes.txt'  # changed
